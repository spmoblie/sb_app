...
public class ReserveListActivity_ViewBinding<T extends ReserveListActivity> implements Unbinder {
  protected T target;

  public ReserveListActivity_ViewBinding(T target, Finder finder, Object source) {
    this.target = target;
