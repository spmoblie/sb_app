...
public class MyTicketsActivity_ViewBinding<T extends MyTicketsActivity> implements Unbinder {
  protected T target;

  public MyTicketsActivity_ViewBinding(T target, Finder finder, Object source) {
    this.target = target;
