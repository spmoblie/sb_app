...
public class MySignUpActivity_ViewBinding<T extends MySignUpActivity> implements Unbinder {
  protected T target;

  public MySignUpActivity_ViewBinding(T target, Finder finder, Object source) {
    this.target = target;
