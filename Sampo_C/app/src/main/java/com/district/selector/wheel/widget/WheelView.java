...
package com.district.selector.wheel.widget;
...
import com.district.selector.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.app_color_gray_c)); //中间线条颜色
		// 设置线宽
