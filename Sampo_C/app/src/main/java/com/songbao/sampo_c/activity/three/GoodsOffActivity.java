...
public class GoodsOffActivity extends BaseActivity implements OnClickListener {

    String TAG = GoodsOffActivity.class.getSimpleName();

    @BindView(R.id.goods_off_view_sv)
    ObservableScrollView goods_sv;

    @BindView(R.id.goods_off_view_vp)
    ViewPager goods_vp;

    @BindView(R.id.goods_off_vp_indicator)
    LinearLayout vp_indicator;

    @BindView(R.id.goods_off_tv_goods_name)
    TextView tv_name;

    @BindView(R.id.goods_off_iv_code)
    ImageView iv_code;

    @BindView(R.id.goods_off_tv_code_show)
    TextView tv_code_show;

    @BindView(R.id.goods_off_tv_click)
    TextView tv_click;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goods_off);
    ...
    private void loadGoodsData() {
        ...
        loadSVData(AppConfig.URL_GOODS_INFO_OFF, map, HttpRequests.HTTP_GET, AppConfig.REQUEST_SV_GOODS_INFO);
    }
        ...
        try {
            switch (dataType) {
                case AppConfig.REQUEST_SV_GOODS_INFO:
                    baseEn = JsonUtils.getGoodsDownData(jsonObject);
