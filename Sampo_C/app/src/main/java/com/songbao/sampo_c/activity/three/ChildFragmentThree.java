...
import com.songbao.sampo_c.adapter.GoodsGridAdapter;
...
import com.songbao.sampo_c.widgets.pullrefresh.PullToRefreshGridView;
...
public class ChildFragmentThree extends BaseFragment implements OnClickListener {

	String TAG = ChildFragmentThree.class.getSimpleName();

	@BindView(R.id.fg_three_rv_left)
	PullToRefreshRecyclerView rv_left;

	@BindView(R.id.fg_three_gv_right)
	PullToRefreshGridView gv_right;

	@BindView(R.id.fg_three_data_null_main)
	ConstraintLayout view_null;

	@BindView(R.id.fg_three_iv_scan)
	ImageView iv_scan;
	...
	public View onCreateView(@Nullable LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = View.inflate(getActivity(), R.layout.fragment_layout_three, null);
		//Butter Knife初始化
	...
	private void initRecyclerView() {
		...
		gv_Adapter.addCallback(new AdapterCallback() {
			...
			public void setOnClick(Object data, int position, int type) {
				...
				openGoodsOffActivity(al_right.get(position).getGoodsCode());
			}
		});
