package com.songbao.sampo_c.widgets.area;
...
public class IndexDisplayTool {
	...
	private static ArrayList<Pair<String, List<? extends IndexDisplay>>> buildIndexListChineseAndEng(
		...
		try{
			SparseArray<String> index = IndexSorter.sortArrayWithStrokeOrder(
					dataList, new IndexSorter.SortValue<IndexDisplay>() {
						@Override
	...
	public static int getStroke(String utfString) throws UnsupportedEncodingException {
		int strokes = 0;
		if (utfString != null) {
