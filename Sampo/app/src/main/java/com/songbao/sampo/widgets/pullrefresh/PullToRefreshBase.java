package com.songbao.sampo.widgets.pullrefresh;
...
import com.songbao.sampo.widgets.pullrefresh.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public void setLastUpdatedLabel(CharSequence label){
        if (null != mHeaderLayout) {
            //mHeaderLayout.setLastUpdatedLabel(label); //Xu
        }
        
        if (null != mFooterLayout) {
            //mFooterLayout.setLastUpdatedLabel(label); //Xu
        }
    }
    ...
    protected LoadingLayout createHeaderLoadingLayout(Context context, AttributeSet attrs) {
        ...
        return new RotateLoadingLayout(context); //Xu
    }
    ...
    public void setFooterLayoutBackground(int colorId) {
        if (mFooterLayout != null) {
            mFooterLayout.setFooterLayoutBackground(colorId);
        }
    }
}
